...
🔹 This is Demo 1: It uses a dataset with 201 façade alternatives, including all input parameters used in performance simulation. It supports optimization and sensitivity analysis. However, it is limited to only two performance metrics — Energy Use Intensity (EUI) and daylight illuminance (UDI).
---
